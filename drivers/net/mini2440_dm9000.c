// mz8023yt@163.com 20180520 begin >>> [1/2] realize the dm9000 net driver
/*
...
enum DM9KS_PHY_mode
{
        DM9KS_10MHD = 0, DM9KS_100MHD = 1, DM9KS_10MFD = 4, DM9KS_100MFD = 5, DM9KS_AUTO = 8,
};
...
static struct ethtool_ops dmfe_ethtool_ops = { .get_drvinfo = dmfe_get_drvinfo, .get_settings = dmfe_get_settings,
.set_settings = dmfe_set_settings, .get_link = dmfe_get_link, .nway_reset = dmfe_nway_reset, .get_rx_csum =
dmfe_get_rx_csum, .set_rx_csum = dmfe_set_rx_csum, .get_tx_csum = dmfe_get_tx_csum, .set_tx_csum = dmfe_set_tx_csum, };
#endif
...
// mz8023yt@163.com 20180520 end   <<< [1/2] realize the dm9000 net driver
